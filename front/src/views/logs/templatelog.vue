  ...
  <div class="departContent app-container calendar-list-container">
    ...
    <div class="table_content tablecheck">
      <el-table v-loading="listLoading"
        ...
        <!-- <el-table-column prop="history_id" label="history_id" width="100px" v-if="false"></el-table-column> -->
        <el-table-column prop="name" align="center" label="名称"/>
        <el-table-column prop="describe" align="center" label="描述"/>
        <el-table-column :show-overflow-tooltip="true" align="center" prop="content" label="模板内容"/>
...
import { getTemplatelog } from '@/api/api'
