  ...
  <div class="departContent app-container calendar-list-container">
    ...
    <div class="table_content tablecheck">
      <el-table v-loading="listLoading"
        ...
        <el-table-column type="index" label="ID" align="center" width="100px"/>
        <el-table-column prop="domain" label="域名" align="center" width="200px"/>
        <el-table-column prop="name" label="名称" align="center"/>
        <el-table-column prop="room" label="机房" align="center"/>
        <el-table-column :show-overflow-tooltip="true" prop="template" label="模板内容" align="center"/>
        ...
        <el-table-column label="操作时间" align="center" width="200px">
          <template slot-scope="scope">
